  ...
  return (
    ...
    >
      ...
      >
        ...
        {isHolding2x && (
          <div className="absolute top-14 sm:top-18 left-1/2 -translate-x-1/2 z-45 flex items-center justify-center w-11 h-11 rounded-full bg-black/60 backdrop-blur-md text-white border border-white/10 text-sm font-black shadow-2xl tracking-wider select-none animate-pulse pointer-events-none">
            2x
          </div>
        )}
        ...
        {showAdOverlay && (
          ...
          >
            ...
            <div
              className="w-full max-w-sm bg-white/5 border border-white/10 rounded-3xl p-6 shadow-2xl flex flex-col items-center gap-4 animate-fade-in cursor-default"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Poster Image */}
              <div className="relative w-32 h-44 rounded-2xl overflow-hidden shadow-xl border border-white/10 shrink-0">
                <img
              ...
              <div className="flex gap-3 w-full mt-1">
                ...
                <button
                  ...
                  className="flex-1 py-2.5 px-4 rounded-xl bg-white/10 hover:bg-white/15 active:scale-95 border border-white/10 text-white font-semibold text-xs transition-all"
                >
                  Cancel
                </button>
              </div>
      ...
      {!isFullscreen && (
        ...
        >
          ...
          {(isScrubbing || isPlaying) && duration > 0 && (
            <div
              className={`absolute bottom-5 -translate-x-1/2 px-2 py-0.5 rounded bg-black/90 backdrop-blur-md border border-white/20 text-white font-mono text-[10px] font-semibold pointer-events-none shadow-xl transition-opacity duration-150 z-50 ${
        ...
        >
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="w-10 h-10 rounded-full bg-black/60 backdrop-blur-md border border-white/20 flex items-center justify-center text-white hover:bg-white/20 active:scale-95 transition-all shadow-lg cursor-pointer"
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-center gap-2 text-[11px] font-semibold text-gray-300 flex-wrap">
                  ...
                  <span className="bg-white/10 px-2 py-0.5 rounded border border-white/10 text-cyan-300 uppercase font-mono">
                    {server} • {qualityLabel}
                  </span>
            ...
            <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={`w-10 h-10 rounded-full border backdrop-blur-md transition-all flex items-center justify-center shadow-lg active:scale-95 cursor-pointer ${
                    showDebugLogs
                      ...
                      : 'bg-black/60 border-white/20 hover:bg-white/20 text-gray-200'
                  }`}
              ...
              <button
                ...
                className="w-10 h-10 rounded-full bg-black/60 backdrop-blur-md border border-white/20 hover:bg-white/20 flex items-center justify-center text-white active:scale-95 transition-all shadow-lg cursor-pointer"
          ...
          >
            ...
            <button
              ...
              className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-pink-600/90 backdrop-blur-md border-2 border-white/40 flex items-center justify-center text-white hover:bg-pink-500 hover:scale-105 active:scale-90 transition-all shadow-[0_0_30px_rgba(236,72,153,0.5)] cursor-pointer"
          ...
          >
            ...
            >
              ...
              {(isScrubbing || isPlaying) && duration > 0 && (
                <div
                  className={`absolute -top-7 -translate-x-1/2 px-2.5 py-1 rounded-md bg-black/95 backdrop-blur-md border border-white/30 text-white font-mono text-xs font-bold pointer-events-none shadow-2xl transition-opacity duration-150 z-50 ${
                    isScrubbing ? 'opacity-100 scale-105' : 'opacity-0 group-hover:opacity-100'
                  }`}
                  style={{
                    left: `${Math.max(6, Math.min(94, displayProgress))}%`,
        ...
        <div className="absolute top-14 sm:top-16 right-3 sm:right-4 z-30 flex flex-col items-center gap-2">
          {onToggleHideFeedUi && (
            <button
              ...
              className={`w-9 h-9 sm:w-10 sm:h-10 rounded-full border backdrop-blur-md transition-all flex items-center justify-center shadow-xl active:scale-90 cursor-pointer ${
                hideFeedUi
                  ? 'bg-black/30 border-white/10 text-white/40 opacity-40 hover:opacity-100'
                  : 'bg-black/50 border-white/20 hover:bg-black/70 text-gray-200'
              }`}
          ...
          {!hideFeedUi && (
            <button
              ...
              className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-black/50 backdrop-blur-md border border-white/20 flex items-center justify-center text-white hover:bg-black/70 active:scale-90 transition-all shadow-xl cursor-pointer"
              title="Subtitle & Player Settings"
            >
      ...
      {showDebugLogs && (
        <div
          className="absolute inset-x-2 top-20 bottom-20 z-50 bg-black/95 backdrop-blur-xl border border-white/20 rounded-2xl p-4 flex flex-col text-white shadow-2xl select-text overflow-hidden"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Header */}
          <div className="flex items-center justify-between border-b border-white/10 pb-2.5 mb-3">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-2.5 py-1 bg-white/10 hover:bg-white/20 border border-white/20 rounded-md text-[11px] font-mono flex items-center gap-1 transition-colors"
              ...
              <button
                ...
                className="p-1 bg-white/10 hover:bg-red-500/20 text-gray-300 hover:text-red-400 border border-white/20 rounded-md transition-colors"
                title="Clear logs"
              >
              ...
              <button
                ...
                className="p-1 bg-white/10 hover:bg-white/20 text-gray-300 rounded-md border border-white/20 transition-colors"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
          ...
          <div className="bg-black/60 border border-white/10 rounded-lg p-2 mb-3 text-[10px] font-mono flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              ...
              <button
                ...
                className="px-1.5 py-0.5 bg-white/10 hover:bg-white/20 rounded border border-white/20 text-cyan-300 active:scale-95 transition-all"
          ...
          {/* Live Log Stream */}
          <div className="flex-1 overflow-y-auto font-mono text-[11px] space-y-1 bg-black/80 p-2.5 rounded-xl border border-white/10 shadow-inner custom-scrollbar">
            {debugLogs.length === 0 ? (
