            ...
            {deferredPrompt ? (
              <div className="space-y-3">
                <button
                  ...
                  className="w-full py-3.5 px-5 rounded-xl bg-pink-500 hover:bg-pink-600 font-bold text-sm text-white shadow-lg shadow-pink-500/25 flex items-center justify-center gap-2 transition-all active:scale-95 cursor-pointer"
                >
                ...
                <button
                  onClick={onClose}
                  className="w-full py-3 px-5 rounded-xl bg-white/5 hover:bg-white/10 font-semibold text-xs text-zinc-400 hover:text-white transition-colors cursor-pointer"
                >
                  Maybe Later
                </button>
              </div>
              ...
              <div className="space-y-4">
                ...
                <button
                  onClick={onClose}
                  className="w-full py-2.5 px-5 rounded-xl bg-white/5 hover:bg-white/10 font-semibold text-xs text-zinc-400 hover:text-white transition-colors cursor-pointer"
                >
                  Close
                </button>
              </div>
              ...
              <div className="space-y-4">
                ...
                <button
                  onClick={onClose}
                  className="w-full py-3 px-5 rounded-xl bg-pink-500 hover:bg-pink-600 font-bold text-sm text-white transition-colors cursor-pointer"
                >
                  Got It
                </button>
              </div>
