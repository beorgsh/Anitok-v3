      ...
      {isOpen && (
        ...
        >
          ...
          >
            <button 
              onClick={onClose}
              className="absolute top-4 right-4 p-2 bg-zinc-900 rounded-full text-zinc-400 hover:text-white transition-colors cursor-pointer"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <div className="w-full mt-4">
              {!isConfirmingLogout ? (
                <button
                  ...
                  className="w-full py-3 rounded-xl bg-zinc-900 border border-zinc-800 text-red-400 font-bold text-sm hover:bg-zinc-800 hover:text-red-300 transition-colors flex items-center justify-center gap-2 cursor-pointer"
                >
                ...
                <div className="space-y-3 animate-in fade-in slide-in-from-bottom-2 duration-200">
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 py-2.5 rounded-xl bg-zinc-900 text-white font-bold text-sm hover:bg-zinc-800 transition-colors cursor-pointer"
                    >
                      Cancel
                    </button>
                    <button
                      ...
                      disabled={isLoggingOut}
                      className="flex-1 py-2.5 rounded-xl bg-red-500 text-white font-bold text-sm hover:bg-red-600 transition-colors flex items-center justify-center cursor-pointer"
                    >
