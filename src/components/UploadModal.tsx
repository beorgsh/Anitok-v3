...
export const UploadModal: React.FC<UploadModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-xs flex items-center justify-center p-4 animate-fade-in text-zinc-200">
      <div className="w-full max-w-sm bg-zinc-900/98 border border-zinc-800 rounded-3xl p-6 shadow-2xl relative overflow-hidden">
        <button
          onClick={onClose}
